...
namespace GestionUtilisateur.Services
{
    /// <summary>
    ...
    public class ApiService
    {
        ...
        //  Une seule adresse de base a modifier pour changer de serveur.
        // ============================================================
        private const string BaseUrl = "http://localhost/backend";

        // URL d'accès aux différents scripts PHP gérant le CRUD
        private const string ListUrl = BaseUrl + "/list.php";
        private const string CreateUrl = BaseUrl + "/create.php";
        private const string UpdateUrl = BaseUrl + "/update.php";
        private const string DeleteUrl = BaseUrl + "/delete.php";
        private const string DetailsUrl = BaseUrl + "/details.php";
